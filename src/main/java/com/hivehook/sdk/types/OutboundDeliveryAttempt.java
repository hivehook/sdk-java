...
/**
 * One attempt to deliver an outbound message.
 *
 * @param id             attempt UUID.
 * @param deliveryId     parent delivery UUID.
 * @param attemptNumber  1-based attempt number.
 * @param responseStatus HTTP status returned by the endpoint.
 * @param responseBody   endpoint response body (truncated by the server).
 ...
 */
public record OutboundDeliveryAttempt(
